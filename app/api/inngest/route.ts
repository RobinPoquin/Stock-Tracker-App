...
import {sendDailyNewsSummary, sendSignUpEmail} from "@/lib/inngest/functions"; // Fonction Inngest personnalisée (ex: envoi d’email après inscription)

// Création des handlers HTTP pour Next.js (App Router)
export const { GET, POST, PUT } = serve({
    client: inngest,               // Client Inngest configuré
    functions: [sendSignUpEmail, sendDailyNewsSummary],  // Liste des fonctions Inngest exposées
});
